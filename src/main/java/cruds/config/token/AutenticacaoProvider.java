...
public class AutenticacaoProvider implements AuthenticationProvider {
  ...
  private final UserAuthenticationService usuarioAutorizacaoService;
  private final PasswordEncoder passwordEncoder;

  public AutenticacaoProvider(UserAuthenticationService usuarioAutorizacaoService, PasswordEncoder passwordEncoder) {
